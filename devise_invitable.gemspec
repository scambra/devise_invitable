...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "test/rails_app/vendor/plugins/dynamic_form/MIT-LICENSE",
     "test/rails_app/vendor/plugins/dynamic_form/README",
     "test/rails_app/vendor/plugins/dynamic_form/Rakefile",
     "test/rails_app/vendor/plugins/dynamic_form/init.rb",
     "test/rails_app/vendor/plugins/dynamic_form/lib/action_view/helpers/dynamic_form.rb",
     "test/rails_app/vendor/plugins/dynamic_form/lib/action_view/locale/en.yml",
     "test/rails_app/vendor/plugins/dynamic_form/test/dynamic_form_i18n_test.rb",
     "test/rails_app/vendor/plugins/dynamic_form/test/dynamic_form_test.rb",
     "test/rails_app/vendor/plugins/dynamic_form/test/test_helper.rb",
     "test/routes_test.rb",
