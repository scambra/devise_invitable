...
Use version 0.6.4, add in your Gemfile:

  gem "devise",           ">= 1.1.1"
  gem "rymai-devise_invitable", :require => "devise_invitable", :git => "git://github.com/rymai/devise_invitable.git", :tag => "v0.6.4"

=== Rails 3.0.0.beta4 and Devise 1.1.rc2

Use version 0.6.2, add in your Gemfile:
...
Copyright (c) 2009 Rémy Coutable. See LICENSE for details.