...
Skip_invitation skips sending the email, but sets invitation_sent_at to the current time, adds a flash
message saying an email was sent, and invited_to_sign_up? on the resulting user returns true.
